...
const ABOUT_SKILLS = [
    { icon: Code, key: "webDevelopment", color: "from-blue-500 to-indigo-600" },
    { icon: Bug, key: "bugFixing", color: "from-green-500 to-emerald-600" },
    { icon: Palette, key: "uiux", color: "from-purple-500 to-pink-500" }
]
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="relative z-10 space-y-3">
                                        ...
                                        <h4 className="text-lg font-bold text-secondary">{t(`about.skills.${skill.key}.title`)}</h4>
                                        <p className="text-sm text-muted/80">{t(`about.skills.${skill.key}.description`)}</p>
                                    </div>
                                </div>
                            );
                        })}
