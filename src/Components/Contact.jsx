                ...
                <div className="grid grid-cols-1 gap-12">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div className="rounded-xl border border-white/10 bg-white/5 p-6 text-center hover:translate-y-[-2px] hover:shadow-lg transition">
                            ...
                            <h4 className="font-medium text-secondary">{t("contact.email")}</h4>
                            <a
                        ...
                        <div className="rounded-xl border border-white/10 bg-white/5 p-6 text-center hover:translate-y-[-2px] hover:shadow-lg transition">
                            ...
                            <h4 className="font-medium text-secondary">{t("contact.phone")}</h4>
                        ...
                        <div className="rounded-xl border border-white/10 bg-white/5 p-6 text-center hover:translate-y-[-2px] hover:shadow-lg transition">
                            ...
                            <h4 className="font-medium text-secondary mb-2">{t("contact.follow")}</h4>
                            <div className="flex justify-center gap-3">
                                {SOCIALS.map((social) => {
                                    const Icon = social.icon
                                    const label = t(`contact.socials.${social.labelKey}`)
                                    ...
                                    return (
                                        <a
                                            ...
                                            aria-label={t("contact.openSocial", { label })}
